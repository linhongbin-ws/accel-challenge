...
class RosCommunication:
    def __init__(self):
        ...
        self.rosCom_subs = rospy.Subscriber("/Tstone_msgs/estimation_num", Int32, self.estimation_numCallback)
        # Wait a until subscribers and publishers are ready
        rospy.sleep(0.5)
...
if __name__ == "__main__":
    ...
    # communication with task_challenge3
    ...
    while not rospy.is_shutdown():
        ...
        if cur_estimation_num > pre_estimation_num:
            ...
            param_dict = [{'params': q11, 'lr': 1e-2},  # degree
                        {'params': q22, 'lr': 1e-2},  # degree
